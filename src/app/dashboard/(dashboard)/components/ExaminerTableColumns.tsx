...
import { onEditExaminer } from "../actions/onEditExaminer";
...
export const columns: ColumnDef<Examiner>[] = [
  {
    ...
    cell: ({ row }) => (
      <div className="flex items-center">
        <Button variant="ghost" onClick={() => onEditExaminer(row.original)}>
  ...
  TableColumn("qualification_code", "المؤهل", (examiner) =>
    ConvertQualificationCode(examiner.qualification_code)
  ),
